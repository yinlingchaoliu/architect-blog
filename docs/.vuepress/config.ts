...
const DOMAIN_NAME = 'yinlingchaoliu.gitee.io' // 域名 (不带https)
...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
	...
	themeConfig: {
		...
		repo: 'yinlingchaoliu/architect-blog', // 导航栏右侧生成Github链接
		...
		author: {
			name: 'chentong', // 必需
			link: 'https://github.com/yinlingchaoliu', // 可选的
		},

		// 博主信息 (显示在首页侧边栏)
		blogger: {
			avatar: '/img/chentong0209.png',
			name: '陈桐',
			slogan: '引领潮流',
		},
			...
			icons: [
				{
					...
					title: '发邮件',
					link: 'mailto:704514698@qq.com',
				},
				{
					iconClass: 'icon-github',
					title: 'GitHub',
					link: 'https://github.com/yinlingchaoliu',
				},
				{
					iconClass: 'icon-erji',
					title: '听音乐',
					link: 'https://music.163.com/#/playlist?id=8308739582',
				},
			],
		},
	...
	head: [
		...
		['meta', { name: 'baidu-site-verification', content: 'codeva-xeeBvuMQbl' }], // 百度统计的站长验证（你可以去掉）
		...
		[
			'vuepress-plugin-comment', // 评论
			{
				...
				options: {
					...
					id: '<%- ((frontmatter.to.path || window.location.pathname)).slice(-50) %>',
